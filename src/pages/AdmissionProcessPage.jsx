    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-white overflow-hidden">
      ...
      <section className="relative pt-28 pb-20">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <span className="inline-block px-5 py-2 rounded-full bg-[#DEB22F]/10 text-[#b18c1d] font-semibold text-sm uppercase tracking-widest animate-[fadeIn_0.8s_ease-out]">
            Admission Process
          </span>
