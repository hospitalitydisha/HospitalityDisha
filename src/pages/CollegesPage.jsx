      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-gray-600 text-lg">
            Filter by your desired program level and location to discover
            the best Hotel Management institutions in the state.
          </p>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8">
            ...
            <div className="w-full lg:w-64 shrink-0 border-t lg:border-t-0 lg:border-l border-gray-100 pt-6 lg:pt-0 lg:pl-8">
              ...
              <label className="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-3 flex items-center gap-2">
                <MapPin className="h-4 w-4 text-[#DEB22F]" />
                Choose Location
              </label>
          ...
          {filteredColleges.length > 0 ? (
              ...
              >
                ...
                <div className="h-48 relative overflow-hidden">
                  ...
                  <div className="absolute top-4 right-4">
                    ...
                    <span
                      className={`px-3 py-1 rounded-full text-xs font-bold shadow-sm backdrop-blur-md border ${
                        college.type.includes('State')
                          ? 'bg-[#DEB22F] text-black border-[#DEB22F]'
                          : 'bg-white/95 text-black border-white'
                      }`}
                    >
                      {college.type}
                    </span>
                ...
                {/* ================= COLLEGE INFORMATION ================= */}
                <div className="p-6 md:p-8 pt-3 flex flex-col flex-grow">
            ...
            <div className="col-span-full text-center py-20 bg-white rounded-[2rem] border border-gray-100 animate-fade-in-up">
              ...
              <p className="text-gray-500">
                ...
                We currently don't have a record of{' '}
