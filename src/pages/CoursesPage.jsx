  ...
  const categoryConfig = [
    {
      ...
      icon: GraduationCap,
      description:
        'Comprehensive 3 to 4-year undergraduate programs designed to build future hospitality leaders.'
    },
    {
      id: 'Aviation & Airport Hospitality',
      icon: Plane,
      description:
        'Career-focused aviation, airport, airline hospitality, ground handling and travel management programs.'
    },
    {
      id: 'Diploma Courses',
      icon: Award,
      description:
        'Intensive 1 to 1.5-year programs focusing on core operational skills and practical training.'
    },
    {
      id: 'Certificate Courses',
      icon: BadgeCheck,
      description:
        'Short-term 6 to 12-month skill-based craftsmanship programs for quick industry entry.'
    },
    {
      id: 'Postgraduate',
      icon: BookOpen,
      description:
        'Advanced 2-year degrees and specializations for graduates seeking upper-management roles.'
    }
  ];
    ...
    <div className="font-sans text-charcoal bg-bgLight min-h-screen pt-24 pb-12">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12 text-center">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
          From short-term craftsmanship certificates to comprehensive
          undergraduate and postgraduate programs, discover the perfect
          academic path to launch your global career in hospitality,
          aviation, tourism and airport management.
        </p>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-24 space-y-24 min-h-[50vh]">
        {displayedCategories.map((category) => {
          ...
          // If a category has no courses, skip rendering it
        ...
        <div className="max-w-7xl mx-auto bg-[#151515] rounded-[2.5rem] relative overflow-hidden shadow-2xl border border-gray-800">
          ...
          <div className="relative z-10 px-8 py-20 md:py-24 text-center max-w-4xl mx-auto">
            ...
            <p className="text-gray-400 mb-10 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
              Every student has different career goals. Speak with our expert
              admission counsellors to map out the perfect educational route
              for your future in hospitality, aviation and travel.
            </p>
